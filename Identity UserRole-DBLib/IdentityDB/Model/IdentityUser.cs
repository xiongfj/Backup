...
namespace IdentityDB.Model
{
	...
	{
		protected TKey _Id;
		protected string _Email = null;                   // null
		protected bool _EmailConfirmed;
		protected string _PasswordHash = null;            // null
		protected string _SecurityStamp = null;           // null
		protected string _PhoneNumber = null;             // null
		protected bool _PhoneNumberConfirmed;
		protected bool _TwoFactorEnabled;
		protected DateTime? _LockoutEndDateUtc = null;    // null
