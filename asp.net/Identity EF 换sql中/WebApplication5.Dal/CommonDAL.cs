...
namespace WebApplication5.Dal
{
    ...
    public class CommonDAL : CommonBaseDAL
    {
        ...
        public DataTable ExecuteTable(string sql, DbParameter param)
        {
            return dbHelper.ExecuteTable(sql, param);
        }
        public DataTable ExecuteTable(string sql, DbParameter[] paramlist)
        {
            return dbHelper.ExecuteTable(sql, paramlist);
        }
        #region 通用（增、改）方法
        /// <summary>
        ...
        public object Add(IModel.IModel model, bool isBackIdentity)
        {
