...
namespace mvcIdentity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private MyApplicationSignInManager _mysignInManager;
        private MyApplicationUserManager _myuserManager;
        ...
        public MyApplicationSignInManager MySignInManager
        {
            get
            {
                return _mysignInManager ?? HttpContext.GetOwinContext().Get<MyApplicationSignInManager>();
            }
            private set
            {
                _mysignInManager = value;
            }
        }

        public MyApplicationUserManager MyUserManager
        {
            get
            {
                return _myuserManager ?? HttpContext.GetOwinContext().GetUserManager<MyApplicationUserManager>();
            }
            private set
            {
        ...
        {
            var appUser = new MyApplicationUser { UserName = model.Email, Email = model.Email };
