...
namespace mvcIdentity.MyIdentity
{
    ...
    public class MyUserStore<TUser> : IUserLoginStore<TUser>,
        ...
        IUserStore<TUser>
    where TUser : MyIdentity.MyIdentityUser
    {
       ...
       // private UserLoginsTable userLoginsTable;
        ...
        public Task<TUser> FindByIdAsync(string userId)
        {
            ...
            CommonBLL bll = new CommonBLL();
            DataTable table = bll.ExecuteTable(commandText, param);//_database.Query(commandText, parameters);
