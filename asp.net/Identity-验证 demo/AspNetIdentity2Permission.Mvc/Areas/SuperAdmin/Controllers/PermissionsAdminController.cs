...
namespace AspNetIdentity2Permission.Mvc.Areas.SuperAdmin.Controllers
{
    public class PermissionsAdminController : BaseController
    {
        ...
        public async Task<ActionResult> Index(int index = 1)
        {
            ...
            // ToPageList 是 MVC 对IEnumerable<T> IQueryable<T> 的扩展方法
        ...
        public ActionResult Details(string id)
        {
            ...
            ApplicationPermission applicationPermission = _db.Permissions.Find(id); // EF 框架数据库查找函数
        ...
        public ActionResult Create()
        {
            ...
            // 程序中所有的控制器中的方法(定义这些方法就是所有的权限)
            var allPermissions = _permissionsOfAssembly;

            // 获取已经存储在数据库的controller.action
